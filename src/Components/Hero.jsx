    ...
    <>
      <div className="relative h-auto w-auto flex flex-col">
        ...
        <div className="relative opacity-100 z-20 grid items-center justify-items-center nike-container">
          ...
          <div className="">
            <img src={img} alt="hero-img" className="w-auto h-[45vh] lg:h-[35vh] md:h-[31vh] sm:h-[21vh] xsm:h-[19vh] transitions-theme -rotate-[25deg] hover:rotate-0 cursor-pointer object-fill" />
          </div>
        </div>
      </div>
    </>
